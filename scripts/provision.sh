...
mysql --user="root" --password="secret" -e "CREATE USER 'starcorp'@'0.0.0.0' IDENTIFIED BY 'starcorp';"
mysql --user="root" --password="secret" -e "GRANT ALL ON *.* TO 'starcorp'@'0.0.0.0' IDENTIFIED BY 'starcorp' WITH GRANT OPTION;"
mysql --user="root" --password="secret" -e "GRANT ALL ON *.* TO 'starcorp'@'%' IDENTIFIED BY 'starcorp' WITH GRANT OPTION;"
mysql --user="root" --password="secret" -e "FLUSH PRIVILEGES;"
mysql --user="root" --password="secret" -e "CREATE DATABASE starcorp character set UTF8mb4 collate utf8mb4_bin;"
service mysql restart
